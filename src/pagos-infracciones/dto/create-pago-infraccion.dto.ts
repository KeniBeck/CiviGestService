...
export class CreatePagoInfraccionDto {
  @ApiProperty({
    description: 'ID de la multa (catálogo de infracciones) que se está pagando',
    example: 1,
  })
  @IsInt()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Folio único de la infracción levantada',
  ...
  @ApiProperty({
    description: 'Costo base de la infracción',
    example: 1500.00,
  })
  @Type(() => Number)
  ...
  @ApiPropertyOptional({
    description: 'Referencia del pago (para transferencias o tarjetas)',
    example: 'REF-123456',
  })
  @IsOptional()
  @IsString()
